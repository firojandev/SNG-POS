...
/**
 * Payment to Supplier Index Page Manager
 *
 * @package    SNG-POS
 * @subpackage Payment to Supplier Module
 * @version    1.0.0
 */

class PaymentToSupplierIndexManager {
    constructor() {
        // Configuration
        this.routes = window.paymentToSupplierRoutes || {};
        this.config = window.paymentToSupplierConfig || {};
     ...
     */
    init() {
        console.log('PaymentToSupplierIndexManager: Initializing...');
    ...
    initializeDatePickers() {
        if (typeof $.fn.datepicker !== 'undefined') {
            const phpFmt = (window.paymentToSupplierConfig && window.paymentToSupplierConfig.dateFormatPhp)
                ? window.paymentToSupplierConfig.dateFormatPhp
                : 'Y-m-d';
...
$(document).ready(function() {
    window.paymentToSupplierIndexManager = new PaymentToSupplierIndexManager();
});
