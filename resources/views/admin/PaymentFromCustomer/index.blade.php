...
@push('js')
    ...
    <script>
        ...
        /**
         * Payment from Customer Index Page Configuration
         */
        window.paymentFromCustomerRoutes = {
            getData: '{{ route('payment-from-customer.getData') }}',
            exportCsv: '{{ route('payment-from-customer.exportCsv') }}'
        };

        window.paymentFromCustomerConfig = {
    ...
    <!--============== Payment from Customer Index JS =================-->
    <script type="text/javascript" src="{{asset('admin/partial/js/payment-from-customer-index.js')}}"></script>
    <!--============== End Payment from Customer Index JS =================-->
@endpush
