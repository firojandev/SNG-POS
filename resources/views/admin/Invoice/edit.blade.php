                        ...
                        <div class="row gx-2">
                            <div class="col-9">
                                <div class="row gx-2">
                                    ...
                                    <div class="col-6">
                                        <div class="pos-input">
                                            <input type="text" id="invoiceDate" name="date" class="form-control form-control-sm" placeholder="{{ get_option('date_format', 'Y-m-d') }}" value="{{ $invoice->date }}" required autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@push('js')
    ...
    <script>
        ...
        window.invoiceRoutes = {
            ...
            store: '{{ route('invoice.update', $invoice->uuid) }}',
