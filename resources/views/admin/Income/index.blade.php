    ...
    <main class="main-content">
        ...
        <div class="theme-card">
            <div class="theme-card-header d-flex justify-content-between">
                ...
                <div>
                    <button type="button" class="btn btn-sm w-100 btn-brand-secondary" data-bs-toggle="modal" data-bs-target="#incomeModal" onclick="openCreateModal()">
                ...
                <div class="modal-content">
                    ...
                    <form id="incomeForm">
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="income_category_id" class="form-label">Income Category <span class="text-danger">*</span></label>
                                <select id="income_category_id" name="income_category_id" class="form-select select2-dropdown" required>
                                    <option value="">Select category...</option>
                                    @foreach($categories as $cat)
                                        <option value="{{$cat->id}}">{{$cat->name}}</option>
                                    @endforeach
                                </select>
                                <div class="invalid-feedback" id="income_category_idError"></div>
                            </div>
...
@push('js')
    ...
    <script type="text/javascript" src="{{asset('admin/partial/js/income.js')}}"></script>
@endpush
