    ...
    <main class="main-content">
        ...
        <div class="theme-card">
            <div class="theme-card-header d-flex justify-content-between">
                ...
                <div>
                    <button type="button" class="btn btn-sm w-100 btn-brand-secondary" data-bs-toggle="modal" data-bs-target="#expenseCategoryModal" onclick="openCreateModal()">
                ...
                <div class="modal-content">
                    ...
                    <form id="expenseCategoryForm">
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="expenseCategoryName" class="form-label"> Name <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="expenseCategoryName" name="name" required placeholder="Name">
...
@push('js')
    ...
    <script type="text/javascript" src="{{asset('admin/partial/js/expense-category.js')}}"></script>
@endpush
