    ...
    <main class="main-content">
        ...
        <div class="theme-card">
            <div class="theme-card-header d-flex justify-content-between">
                ...
                <div>
                    <button type="button" class="btn btn-sm w-100 btn-brand-secondary" data-bs-toggle="modal" data-bs-target="#incomeCategoryModal" onclick="openCreateModal()">
            ...
            <div class="theme-card-body">
                <div class="table-responsive">
                    <table id="dataTable" class="table data-table">
                        ...
                        <tbody id="incomeCategoryTableBody">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="incomeCategoryModalLabel">Add Income Category</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form id="incomeCategoryForm">
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="incomeCategoryName" class="form-label"> Name <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="incomeCategoryName" name="name" required placeholder="Name">
                                <div class="invalid-feedback" id="nameError"></div>
                            </div>
                            <input type="hidden" id="incomeCategoryId" name="income_category_id">
...
@push('js')
    ...
    <script type="text/javascript" src="{{asset('admin/partial/js/income-category.js')}}"></script>
@endpush
